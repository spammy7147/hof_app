...
export function AutomationHistoryScreen({
  ...
  return <View style={styles.scroller}>
    <View style={styles.header}><Pressable accessibilityLabel="통합 자동화로" accessibilityRole="button" onPress={onBack} style={styles.back}><ArrowLeft color={theme.colors.text} size={20} /></Pressable><View style={{ flex: 1 }}><Text style={styles.title}>자동화 기록</Text><Text style={styles.subtitle}>실제 판단 순서와 실행·스킵 결과를 시간순으로 확인합니다.</Text></View></View>
    <NestableScrollContainer contentContainerStyle={styles.container} style={styles.scroller}>
