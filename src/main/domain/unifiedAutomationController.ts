...
export class UnifiedAutomationController {
  ...
  allowLocalFreshDecision(actionId: number): Promise<AutomationConvergenceStatus> { return this.requireApi(this.api.allowLocalFreshDecision, '후처리 보류 해제')(actionId); }
